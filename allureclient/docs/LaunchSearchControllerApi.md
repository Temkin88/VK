# openapi_client.LaunchSearchControllerApi
...
[**validate_query2**](LaunchSearchControllerApi.md#validate_query2) | **GET** /launch/query/validate | Find all launches by given AQL
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LaunchSearchControllerApi(api_client)
    project_id = 56 # int | 
    rql = 'rql_example' # str | 
    ...
    try:
        # Find all launches by given AQL
        api_response = api_instance.search2(project_id, rql, page=page, size=size, sort=sort)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Find all launches by given AQL
        api_response = api_instance.validate_query2(project_id, rql)
