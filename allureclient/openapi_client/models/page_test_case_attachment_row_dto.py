...
class PageTestCaseAttachmentRowDto(BaseModel):
    ...
    content: Optional[conlist(TestCaseAttachmentRowDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestCaseAttachmentRowDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestCaseAttachmentRowDto:
        """Create an instance of PageTestCaseAttachmentRowDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestCaseAttachmentRowDto.parse_obj(obj)

        _obj = PageTestCaseAttachmentRowDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestCaseAttachmentRowDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
