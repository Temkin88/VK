...
class PageProjectIntegrationDto(BaseModel):
    ...
    content: Optional[conlist(ProjectIntegrationDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageProjectIntegrationDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageProjectIntegrationDto:
        """Create an instance of PageProjectIntegrationDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageProjectIntegrationDto.parse_obj(obj)

        _obj = PageProjectIntegrationDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [ProjectIntegrationDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
