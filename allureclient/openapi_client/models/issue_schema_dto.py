...
class IssueSchemaDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IssueSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IssueSchemaDto:
        """Create an instance of IssueSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IssueSchemaDto.parse_obj(obj)

        _obj = IssueSchemaDto.parse_obj({
            "id": obj.get("id"),
