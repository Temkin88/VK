...
class PageLaunchTagDto(BaseModel):
    ...
    content: Optional[conlist(LaunchTagDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageLaunchTagDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageLaunchTagDto:
        """Create an instance of PageLaunchTagDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageLaunchTagDto.parse_obj(obj)

        _obj = PageLaunchTagDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [LaunchTagDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
