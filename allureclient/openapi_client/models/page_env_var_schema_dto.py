...
class PageEnvVarSchemaDto(BaseModel):
    ...
    content: Optional[conlist(EnvVarSchemaDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageEnvVarSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageEnvVarSchemaDto:
        """Create an instance of PageEnvVarSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageEnvVarSchemaDto.parse_obj(obj)

        _obj = PageEnvVarSchemaDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [EnvVarSchemaDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
