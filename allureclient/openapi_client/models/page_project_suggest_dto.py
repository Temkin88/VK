...
class PageProjectSuggestDto(BaseModel):
    ...
    content: Optional[conlist(ProjectSuggestDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageProjectSuggestDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageProjectSuggestDto:
        """Create an instance of PageProjectSuggestDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageProjectSuggestDto.parse_obj(obj)

        _obj = PageProjectSuggestDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [ProjectSuggestDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
