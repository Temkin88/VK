...
class DiffValueChangeString(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiffValueChangeString:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiffValueChangeString:
        """Create an instance of DiffValueChangeString from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiffValueChangeString.parse_obj(obj)

        _obj = DiffValueChangeString.parse_obj({
