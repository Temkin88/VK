...
class PageIdAndNameOnlyDto(BaseModel):
    ...
    content: Optional[conlist(IdAndNameOnlyDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageIdAndNameOnlyDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageIdAndNameOnlyDto:
        """Create an instance of PageIdAndNameOnlyDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageIdAndNameOnlyDto.parse_obj(obj)

        _obj = PageIdAndNameOnlyDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [IdAndNameOnlyDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
