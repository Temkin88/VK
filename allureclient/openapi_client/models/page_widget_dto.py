...
class PageWidgetDto(BaseModel):
    ...
    content: Optional[conlist(WidgetDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageWidgetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageWidgetDto:
        """Create an instance of PageWidgetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageWidgetDto.parse_obj(obj)

        _obj = PageWidgetDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [WidgetDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
