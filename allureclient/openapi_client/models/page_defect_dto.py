...
class PageDefectDto(BaseModel):
    ...
    content: Optional[conlist(DefectDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDefectDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDefectDto:
        """Create an instance of PageDefectDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageDefectDto.parse_obj(obj)

        _obj = PageDefectDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [DefectDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
