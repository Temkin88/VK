...
class PageProjectGroupAccessDto(BaseModel):
    ...
    content: Optional[conlist(ProjectGroupAccessDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageProjectGroupAccessDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageProjectGroupAccessDto:
        """Create an instance of PageProjectGroupAccessDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageProjectGroupAccessDto.parse_obj(obj)

        _obj = PageProjectGroupAccessDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [ProjectGroupAccessDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
