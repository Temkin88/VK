...
class PageTestCaseDto(BaseModel):
    ...
    content: Optional[conlist(TestCaseDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestCaseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestCaseDto:
        """Create an instance of PageTestCaseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestCaseDto.parse_obj(obj)

        _obj = PageTestCaseDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestCaseDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
