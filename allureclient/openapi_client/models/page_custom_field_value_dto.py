...
class PageCustomFieldValueDto(BaseModel):
    """
    ...
    content: Optional[conlist(CustomFieldValueDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageCustomFieldValueDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageCustomFieldValueDto:
        """Create an instance of PageCustomFieldValueDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageCustomFieldValueDto.parse_obj(obj)

        _obj = PageCustomFieldValueDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [CustomFieldValueDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
