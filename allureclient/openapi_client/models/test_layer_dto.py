...
class TestLayerDto(BaseModel):
    ...
    __properties = ["id", "name", "createdDate", "lastModifiedDate", "createdBy", "lastModifiedBy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestLayerDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestLayerDto:
        """Create an instance of TestLayerDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestLayerDto.parse_obj(obj)

        _obj = TestLayerDto.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
