...
class PageWorkflowSchemaDto(BaseModel):
    ...
    content: Optional[conlist(WorkflowSchemaDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageWorkflowSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageWorkflowSchemaDto:
        """Create an instance of PageWorkflowSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageWorkflowSchemaDto.parse_obj(obj)

        _obj = PageWorkflowSchemaDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [WorkflowSchemaDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
