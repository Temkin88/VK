...
class WorkflowDto(BaseModel):
    ...
    statuses: Optional[conlist(StatusDto)] = None
    ...
    __properties = ["id", "name", "statuses", "createdDate", "lastModifiedDate", "createdBy", "lastModifiedBy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowDto:
        """Create an instance of WorkflowDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowDto.parse_obj(obj)

        _obj = WorkflowDto.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "statuses": [StatusDto.from_dict(_item) for _item in obj.get("statuses")] if obj.get("statuses") is not None else None,
