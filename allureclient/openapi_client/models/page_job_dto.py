...
class PageJobDto(BaseModel):
    ...
    content: Optional[conlist(JobDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageJobDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageJobDto:
        """Create an instance of PageJobDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageJobDto.parse_obj(obj)

        _obj = PageJobDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [JobDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
