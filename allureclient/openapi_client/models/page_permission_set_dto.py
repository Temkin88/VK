...
class PagePermissionSetDto(BaseModel):
    ...
    content: Optional[conlist(PermissionSetDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagePermissionSetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagePermissionSetDto:
        """Create an instance of PagePermissionSetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagePermissionSetDto.parse_obj(obj)

        _obj = PagePermissionSetDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [PermissionSetDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
