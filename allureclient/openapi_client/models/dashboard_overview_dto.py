...
class DashboardOverviewDto(BaseModel):
    ...
    widgets: Optional[conlist(WidgetDto)] = None
    ...
    __properties = ["id", "projectId", "name", "widgets", "createdDate", "lastModifiedDate", "createdBy", "lastModifiedBy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DashboardOverviewDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DashboardOverviewDto:
        """Create an instance of DashboardOverviewDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DashboardOverviewDto.parse_obj(obj)

        _obj = DashboardOverviewDto.parse_obj({
            "id": obj.get("id"),
            "project_id": obj.get("projectId"),
            "name": obj.get("name"),
            "widgets": [WidgetDto.from_dict(_item) for _item in obj.get("widgets")] if obj.get("widgets") is not None else None,
