...
class PageTestResultRowDto(BaseModel):
    ...
    content: Optional[conlist(TestResultRowDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestResultRowDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestResultRowDto:
        """Create an instance of PageTestResultRowDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestResultRowDto.parse_obj(obj)

        _obj = PageTestResultRowDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestResultRowDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
