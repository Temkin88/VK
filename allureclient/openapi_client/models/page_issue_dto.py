...
class PageIssueDto(BaseModel):
    ...
    content: Optional[conlist(IssueDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageIssueDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageIssueDto:
        """Create an instance of PageIssueDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageIssueDto.parse_obj(obj)

        _obj = PageIssueDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [IssueDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
