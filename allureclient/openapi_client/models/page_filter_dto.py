...
class PageFilterDto(BaseModel):
    ...
    content: Optional[conlist(FilterDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageFilterDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageFilterDto:
        """Create an instance of PageFilterDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageFilterDto.parse_obj(obj)

        _obj = PageFilterDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [FilterDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
