...
class PageTestResultTreeLeafDto(BaseModel):
    ...
    content: Optional[conlist(TestResultTreeLeafDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestResultTreeLeafDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestResultTreeLeafDto:
        """Create an instance of PageTestResultTreeLeafDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestResultTreeLeafDto.parse_obj(obj)

        _obj = PageTestResultTreeLeafDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestResultTreeLeafDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
