...
class PageDefectMatcherDto(BaseModel):
    ...
    content: Optional[conlist(DefectMatcherDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDefectMatcherDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDefectMatcherDto:
        """Create an instance of PageDefectMatcherDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageDefectMatcherDto.parse_obj(obj)

        _obj = PageDefectMatcherDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [DefectMatcherDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
