...
class PageIntegrationWebhookLogDto(BaseModel):
    ...
    content: Optional[conlist(IntegrationWebhookLogDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageIntegrationWebhookLogDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageIntegrationWebhookLogDto:
        """Create an instance of PageIntegrationWebhookLogDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageIntegrationWebhookLogDto.parse_obj(obj)

        _obj = PageIntegrationWebhookLogDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [IntegrationWebhookLogDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
