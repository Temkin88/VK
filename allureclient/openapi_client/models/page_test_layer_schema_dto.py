...
class PageTestLayerSchemaDto(BaseModel):
    ...
    content: Optional[conlist(TestLayerSchemaDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestLayerSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestLayerSchemaDto:
        """Create an instance of PageTestLayerSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestLayerSchemaDto.parse_obj(obj)

        _obj = PageTestLayerSchemaDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestLayerSchemaDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
