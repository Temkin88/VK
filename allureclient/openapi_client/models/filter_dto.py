...
class FilterDto(BaseModel):
    ...
    __properties = ["id", "projectId", "name", "body", "base", "shared", "editable", "createdDate", "lastModifiedDate", "createdBy", "lastModifiedBy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilterDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilterDto:
        """Create an instance of FilterDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilterDto.parse_obj(obj)

        _obj = FilterDto.parse_obj({
            "id": obj.get("id"),
