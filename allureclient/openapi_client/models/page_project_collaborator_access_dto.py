...
class PageProjectCollaboratorAccessDto(BaseModel):
    ...
    content: Optional[conlist(ProjectCollaboratorAccessDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageProjectCollaboratorAccessDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageProjectCollaboratorAccessDto:
        """Create an instance of PageProjectCollaboratorAccessDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageProjectCollaboratorAccessDto.parse_obj(obj)

        _obj = PageProjectCollaboratorAccessDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [ProjectCollaboratorAccessDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
