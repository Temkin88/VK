...
class PageTestCaseTreeLeafDto(BaseModel):
    ...
    content: Optional[conlist(TestCaseTreeLeafDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestCaseTreeLeafDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestCaseTreeLeafDto:
        """Create an instance of PageTestCaseTreeLeafDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestCaseTreeLeafDto.parse_obj(obj)

        _obj = PageTestCaseTreeLeafDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestCaseTreeLeafDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
