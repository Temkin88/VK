...
class JobRun(BaseModel):
    ...
    __properties = ["id", "uid", "name", "url", "parameters"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobRun:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobRun:
        """Create an instance of JobRun from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobRun.parse_obj(obj)

        _obj = JobRun.parse_obj({
            "id": obj.get("id"),
            "uid": obj.get("uid"),
            "name": obj.get("name"),
            "url": obj.get("url"),
