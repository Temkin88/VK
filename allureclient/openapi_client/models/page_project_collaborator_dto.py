...
class PageProjectCollaboratorDto(BaseModel):
    ...
    content: Optional[conlist(ProjectCollaboratorDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageProjectCollaboratorDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageProjectCollaboratorDto:
        """Create an instance of PageProjectCollaboratorDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageProjectCollaboratorDto.parse_obj(obj)

        _obj = PageProjectCollaboratorDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [ProjectCollaboratorDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
