...
class PageTestResultDefectMatchDto(BaseModel):
    ...
    content: Optional[conlist(TestResultDefectMatchDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestResultDefectMatchDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestResultDefectMatchDto:
        """Create an instance of PageTestResultDefectMatchDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestResultDefectMatchDto.parse_obj(obj)

        _obj = PageTestResultDefectMatchDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestResultDefectMatchDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
