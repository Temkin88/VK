...
class PageLaunchDiffRow(BaseModel):
    ...
    content: Optional[conlist(LaunchDiffRow)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageLaunchDiffRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageLaunchDiffRow:
        """Create an instance of PageLaunchDiffRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageLaunchDiffRow.parse_obj(obj)

        _obj = PageLaunchDiffRow.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [LaunchDiffRow.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
