...
class PageCategoryMatcherDto(BaseModel):
    ...
    content: Optional[conlist(CategoryMatcherDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageCategoryMatcherDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageCategoryMatcherDto:
        """Create an instance of PageCategoryMatcherDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageCategoryMatcherDto.parse_obj(obj)

        _obj = PageCategoryMatcherDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [CategoryMatcherDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
