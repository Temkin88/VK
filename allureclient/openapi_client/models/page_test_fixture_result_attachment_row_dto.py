...
class PageTestFixtureResultAttachmentRowDto(BaseModel):
    ...
    content: Optional[conlist(TestFixtureResultAttachmentRowDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestFixtureResultAttachmentRowDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestFixtureResultAttachmentRowDto:
        """Create an instance of PageTestFixtureResultAttachmentRowDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestFixtureResultAttachmentRowDto.parse_obj(obj)

        _obj = PageTestFixtureResultAttachmentRowDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestFixtureResultAttachmentRowDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
