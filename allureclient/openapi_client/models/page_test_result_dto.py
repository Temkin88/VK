...
class PageTestResultDto(BaseModel):
    ...
    content: Optional[conlist(TestResultDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestResultDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestResultDto:
        """Create an instance of PageTestResultDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestResultDto.parse_obj(obj)

        _obj = PageTestResultDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestResultDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
