...
class PageTestCaseExampleDto(BaseModel):
    ...
    content: Optional[conlist(TestCaseExampleDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestCaseExampleDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestCaseExampleDto:
        """Create an instance of PageTestCaseExampleDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestCaseExampleDto.parse_obj(obj)

        _obj = PageTestCaseExampleDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestCaseExampleDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
