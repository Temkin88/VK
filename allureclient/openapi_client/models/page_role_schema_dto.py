...
class PageRoleSchemaDto(BaseModel):
    ...
    content: Optional[conlist(RoleSchemaDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageRoleSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageRoleSchemaDto:
        """Create an instance of PageRoleSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageRoleSchemaDto.parse_obj(obj)

        _obj = PageRoleSchemaDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [RoleSchemaDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
