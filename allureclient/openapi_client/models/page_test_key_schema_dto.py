...
class PageTestKeySchemaDto(BaseModel):
    ...
    content: Optional[conlist(TestKeySchemaDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestKeySchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestKeySchemaDto:
        """Create an instance of PageTestKeySchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestKeySchemaDto.parse_obj(obj)

        _obj = PageTestKeySchemaDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestKeySchemaDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
