...
class PageLaunchDto(BaseModel):
    ...
    content: Optional[conlist(LaunchDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageLaunchDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageLaunchDto:
        """Create an instance of PageLaunchDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageLaunchDto.parse_obj(obj)

        _obj = PageLaunchDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [LaunchDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
