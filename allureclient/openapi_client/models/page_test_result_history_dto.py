...
class PageTestResultHistoryDto(BaseModel):
    ...
    content: Optional[conlist(TestResultHistoryDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestResultHistoryDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestResultHistoryDto:
        """Create an instance of PageTestResultHistoryDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestResultHistoryDto.parse_obj(obj)

        _obj = PageTestResultHistoryDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestResultHistoryDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
