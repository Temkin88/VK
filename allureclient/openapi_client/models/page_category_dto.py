...
class PageCategoryDto(BaseModel):
    ...
    content: Optional[conlist(CategoryDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageCategoryDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageCategoryDto:
        """Create an instance of PageCategoryDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageCategoryDto.parse_obj(obj)

        _obj = PageCategoryDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [CategoryDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
