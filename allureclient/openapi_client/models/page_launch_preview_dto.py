...
class PageLaunchPreviewDto(BaseModel):
    ...
    content: Optional[conlist(LaunchPreviewDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageLaunchPreviewDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageLaunchPreviewDto:
        """Create an instance of PageLaunchPreviewDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageLaunchPreviewDto.parse_obj(obj)

        _obj = PageLaunchPreviewDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [LaunchPreviewDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
