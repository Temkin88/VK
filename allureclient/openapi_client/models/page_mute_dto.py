...
class PageMuteDto(BaseModel):
    ...
    content: Optional[conlist(MuteDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageMuteDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageMuteDto:
        """Create an instance of PageMuteDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageMuteDto.parse_obj(obj)

        _obj = PageMuteDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [MuteDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
