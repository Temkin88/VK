...
class PageWorkflowDto(BaseModel):
    ...
    content: Optional[conlist(WorkflowDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageWorkflowDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageWorkflowDto:
        """Create an instance of PageWorkflowDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageWorkflowDto.parse_obj(obj)

        _obj = PageWorkflowDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [WorkflowDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
