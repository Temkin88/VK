...
class PageCustomFieldSchemaDto(BaseModel):
    ...
    content: Optional[conlist(CustomFieldSchemaDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageCustomFieldSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageCustomFieldSchemaDto:
        """Create an instance of PageCustomFieldSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageCustomFieldSchemaDto.parse_obj(obj)

        _obj = PageCustomFieldSchemaDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [CustomFieldSchemaDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
