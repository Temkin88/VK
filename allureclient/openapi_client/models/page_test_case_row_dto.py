...
class PageTestCaseRowDto(BaseModel):
    ...
    content: Optional[conlist(TestCaseRowDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestCaseRowDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestCaseRowDto:
        """Create an instance of PageTestCaseRowDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestCaseRowDto.parse_obj(obj)

        _obj = PageTestCaseRowDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestCaseRowDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
