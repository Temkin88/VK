...
class PageIntegrationWebhookDto(BaseModel):
    ...
    content: Optional[conlist(IntegrationWebhookDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageIntegrationWebhookDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageIntegrationWebhookDto:
        """Create an instance of PageIntegrationWebhookDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageIntegrationWebhookDto.parse_obj(obj)

        _obj = PageIntegrationWebhookDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [IntegrationWebhookDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
