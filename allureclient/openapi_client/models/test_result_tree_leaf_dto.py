...
class TestResultTreeLeafDto(BaseModel):
    ...
    __properties = ["id", "name", "status", "start", "stop", "duration", "flaky", "hidden", "manual", "assignee", "testedBy", "layerName", "testCaseId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultTreeLeafDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestResultTreeLeafDto:
        """Create an instance of TestResultTreeLeafDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultTreeLeafDto.parse_obj(obj)

        _obj = TestResultTreeLeafDto.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
