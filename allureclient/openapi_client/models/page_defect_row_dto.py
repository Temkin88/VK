...
class PageDefectRowDto(BaseModel):
    ...
    content: Optional[conlist(DefectRowDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDefectRowDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDefectRowDto:
        """Create an instance of PageDefectRowDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageDefectRowDto.parse_obj(obj)

        _obj = PageDefectRowDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [DefectRowDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
