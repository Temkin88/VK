...
class CustomFieldSchemaDto(BaseModel):
    ...
    __properties = ["id", "projectId", "key", "customField", "createdDate", "lastModifiedDate", "createdBy", "lastModifiedBy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldSchemaDto:
        """Create an instance of CustomFieldSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldSchemaDto.parse_obj(obj)

        _obj = CustomFieldSchemaDto.parse_obj({
            "id": obj.get("id"),
