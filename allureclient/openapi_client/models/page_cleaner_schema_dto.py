...
class PageCleanerSchemaDto(BaseModel):
    ...
    content: Optional[conlist(CleanerSchemaDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageCleanerSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageCleanerSchemaDto:
        """Create an instance of PageCleanerSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageCleanerSchemaDto.parse_obj(obj)

        _obj = PageCleanerSchemaDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [CleanerSchemaDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
