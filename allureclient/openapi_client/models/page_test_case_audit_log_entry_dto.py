...
class PageTestCaseAuditLogEntryDto(BaseModel):
    ...
    content: Optional[conlist(TestCaseAuditLogEntryDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestCaseAuditLogEntryDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestCaseAuditLogEntryDto:
        """Create an instance of PageTestCaseAuditLogEntryDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestCaseAuditLogEntryDto.parse_obj(obj)

        _obj = PageTestCaseAuditLogEntryDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestCaseAuditLogEntryDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
