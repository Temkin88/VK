...
class PageTreePathDto(BaseModel):
    ...
    content: Optional[conlist(TreePathDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTreePathDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTreePathDto:
        """Create an instance of PageTreePathDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTreePathDto.parse_obj(obj)

        _obj = PageTreePathDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TreePathDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
