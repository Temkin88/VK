...
class PageIntegrationInfoDto(BaseModel):
    ...
    content: Optional[conlist(IntegrationInfoDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageIntegrationInfoDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageIntegrationInfoDto:
        """Create an instance of PageIntegrationInfoDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageIntegrationInfoDto.parse_obj(obj)

        _obj = PageIntegrationInfoDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [IntegrationInfoDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
