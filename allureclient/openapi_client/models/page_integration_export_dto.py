...
class PageIntegrationExportDto(BaseModel):
    ...
    content: Optional[conlist(IntegrationExportDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageIntegrationExportDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageIntegrationExportDto:
        """Create an instance of PageIntegrationExportDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageIntegrationExportDto.parse_obj(obj)

        _obj = PageIntegrationExportDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [IntegrationExportDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
