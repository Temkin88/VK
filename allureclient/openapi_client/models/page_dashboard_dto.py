...
class PageDashboardDto(BaseModel):
    ...
    content: Optional[conlist(DashboardDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDashboardDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDashboardDto:
        """Create an instance of PageDashboardDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageDashboardDto.parse_obj(obj)

        _obj = PageDashboardDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [DashboardDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
