...
class PageProjectDto(BaseModel):
    ...
    content: Optional[conlist(ProjectDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageProjectDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageProjectDto:
        """Create an instance of PageProjectDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageProjectDto.parse_obj(obj)

        _obj = PageProjectDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [ProjectDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
