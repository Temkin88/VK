...
class PageCommentDto(BaseModel):
    ...
    content: Optional[conlist(CommentDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageCommentDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageCommentDto:
        """Create an instance of PageCommentDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageCommentDto.parse_obj(obj)

        _obj = PageCommentDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [CommentDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
