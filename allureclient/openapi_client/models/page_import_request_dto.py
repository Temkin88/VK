...
class PageImportRequestDto(BaseModel):
    ...
    content: Optional[conlist(ImportRequestDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageImportRequestDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageImportRequestDto:
        """Create an instance of PageImportRequestDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageImportRequestDto.parse_obj(obj)

        _obj = PageImportRequestDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [ImportRequestDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
