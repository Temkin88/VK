...
class PageIssueSchemaDto(BaseModel):
    ...
    content: Optional[conlist(IssueSchemaDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageIssueSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageIssueSchemaDto:
        """Create an instance of PageIssueSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageIssueSchemaDto.parse_obj(obj)

        _obj = PageIssueSchemaDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [IssueSchemaDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
