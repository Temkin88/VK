...
class PageTestResultAttachmentRowDto(BaseModel):
    ...
    content: Optional[conlist(TestResultAttachmentRowDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestResultAttachmentRowDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestResultAttachmentRowDto:
        """Create an instance of PageTestResultAttachmentRowDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestResultAttachmentRowDto.parse_obj(obj)

        _obj = PageTestResultAttachmentRowDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestResultAttachmentRowDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
