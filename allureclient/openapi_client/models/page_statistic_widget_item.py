...
class PageStatisticWidgetItem(BaseModel):
    ...
    content: Optional[conlist(StatisticWidgetItem)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageStatisticWidgetItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageStatisticWidgetItem:
        """Create an instance of PageStatisticWidgetItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageStatisticWidgetItem.parse_obj(obj)

        _obj = PageStatisticWidgetItem.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [StatisticWidgetItem.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
