...
class PageMemberDto(BaseModel):
    ...
    content: Optional[conlist(MemberDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageMemberDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageMemberDto:
        """Create an instance of PageMemberDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageMemberDto.parse_obj(obj)

        _obj = PageMemberDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [MemberDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
