...
class RoleSchemaDto(BaseModel):
    ...
    __properties = ["id", "projectId", "key", "role", "createdDate", "lastModifiedDate", "createdBy", "lastModifiedBy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleSchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleSchemaDto:
        """Create an instance of RoleSchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoleSchemaDto.parse_obj(obj)

        _obj = RoleSchemaDto.parse_obj({
            "id": obj.get("id"),
