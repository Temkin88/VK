...
class PageStatusDto(BaseModel):
    ...
    content: Optional[conlist(StatusDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageStatusDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageStatusDto:
        """Create an instance of PageStatusDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageStatusDto.parse_obj(obj)

        _obj = PageStatusDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [StatusDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
