...
class PageDefectCountRowDto(BaseModel):
    ...
    content: Optional[conlist(DefectCountRowDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDefectCountRowDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDefectCountRowDto:
        """Create an instance of PageDefectCountRowDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageDefectCountRowDto.parse_obj(obj)

        _obj = PageDefectCountRowDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [DefectCountRowDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
