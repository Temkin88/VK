...
class PageTestCaseTreeGroupDto(BaseModel):
    ...
    content: Optional[conlist(TestCaseTreeGroupDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestCaseTreeGroupDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestCaseTreeGroupDto:
        """Create an instance of PageTestCaseTreeGroupDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestCaseTreeGroupDto.parse_obj(obj)

        _obj = PageTestCaseTreeGroupDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestCaseTreeGroupDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
