...
class PageIntegrationDto(BaseModel):
    ...
    content: Optional[conlist(IntegrationDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageIntegrationDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageIntegrationDto:
        """Create an instance of PageIntegrationDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageIntegrationDto.parse_obj(obj)

        _obj = PageIntegrationDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [IntegrationDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
