...
class PageTestResultTreeGroupDto(BaseModel):
    ...
    content: Optional[conlist(TestResultTreeGroupDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestResultTreeGroupDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestResultTreeGroupDto:
        """Create an instance of PageTestResultTreeGroupDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestResultTreeGroupDto.parse_obj(obj)

        _obj = PageTestResultTreeGroupDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestResultTreeGroupDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
