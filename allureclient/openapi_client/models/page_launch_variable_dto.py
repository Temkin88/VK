...
class PageLaunchVariableDto(BaseModel):
    ...
    content: Optional[conlist(LaunchVariableDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageLaunchVariableDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageLaunchVariableDto:
        """Create an instance of PageLaunchVariableDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageLaunchVariableDto.parse_obj(obj)

        _obj = PageLaunchVariableDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [LaunchVariableDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
