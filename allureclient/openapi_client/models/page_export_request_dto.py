...
class PageExportRequestDto(BaseModel):
    ...
    content: Optional[conlist(ExportRequestDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageExportRequestDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageExportRequestDto:
        """Create an instance of PageExportRequestDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageExportRequestDto.parse_obj(obj)

        _obj = PageExportRequestDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [ExportRequestDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
