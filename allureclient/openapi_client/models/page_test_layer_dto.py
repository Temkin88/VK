...
class PageTestLayerDto(BaseModel):
    ...
    content: Optional[conlist(TestLayerDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestLayerDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestLayerDto:
        """Create an instance of PageTestLayerDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestLayerDto.parse_obj(obj)

        _obj = PageTestLayerDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestLayerDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
