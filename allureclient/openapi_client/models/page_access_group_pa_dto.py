...
class PageAccessGroupPaDto(BaseModel):
    ...
    content: Optional[conlist(AccessGroupPaDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageAccessGroupPaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageAccessGroupPaDto:
        """Create an instance of PageAccessGroupPaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageAccessGroupPaDto.parse_obj(obj)

        _obj = PageAccessGroupPaDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [AccessGroupPaDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
