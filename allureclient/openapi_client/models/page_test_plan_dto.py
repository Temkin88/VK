...
class PageTestPlanDto(BaseModel):
    ...
    content: Optional[conlist(TestPlanDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTestPlanDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTestPlanDto:
        """Create an instance of PageTestPlanDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTestPlanDto.parse_obj(obj)

        _obj = PageTestPlanDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TestPlanDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
