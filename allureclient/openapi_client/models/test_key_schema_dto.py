...
class TestKeySchemaDto(BaseModel):
    ...
    __properties = ["id", "projectId", "key", "integrationId", "createdDate", "lastModifiedDate", "createdBy", "lastModifiedBy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestKeySchemaDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestKeySchemaDto:
        """Create an instance of TestKeySchemaDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestKeySchemaDto.parse_obj(obj)

        _obj = TestKeySchemaDto.parse_obj({
            "id": obj.get("id"),
