...
class PageTreeDto(BaseModel):
    ...
    content: Optional[conlist(TreeDto)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageTreeDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageTreeDto:
        """Create an instance of PageTreeDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageTreeDto.parse_obj(obj)

        _obj = PageTreeDto.parse_obj({
            "total_elements": obj.get("totalElements"),
            "total_pages": obj.get("totalPages"),
            "size": obj.get("size"),
            "content": [TreeDto.from_dict(_item) for _item in obj.get("content")] if obj.get("content") is not None else None,
