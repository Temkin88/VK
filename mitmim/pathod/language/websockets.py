...
import mock_server.mitmim.mitmproxy.net.websockets
...
class OpCode(base.IntField):
    names: typing.Dict[str, int] = {
        "continue": mock_server.mitmim.mitmproxy.net.websockets.OPCODE.CONTINUE,
        "text": mock_server.mitmim.mitmproxy.net.websockets.OPCODE.TEXT,
        "binary": mock_server.mitmim.mitmproxy.net.websockets.OPCODE.BINARY,
        "close": mock_server.mitmim.mitmproxy.net.websockets.OPCODE.CLOSE,
        "ping": mock_server.mitmim.mitmproxy.net.websockets.OPCODE.PING,
        "pong": mock_server.mitmim.mitmproxy.net.websockets.OPCODE.PONG,
    }
    max = 15
    preamble = "c"
...
class WebsocketFrame(message.Message):
    ...
    def values(self, settings):
        ...
        frame = mock_server.mitmim.mitmproxy.net.websockets.FrameHeader(**frameparts)
        vals = [bytes(frame)]
        if bodygen:
            if frame.masking_key and not self.rawbody:
                masker = mock_server.mitmim.mitmproxy.net.websockets.Masker(frame.masking_key)
                vals.append(
