...
from mock_server.mitmim.mitmproxy.net.http import url
import mock_server.mitmim.mitmproxy.net.websockets
from mock_server.mitmim.mitmproxy.net.http import status_codes, user_agents
...
class Response(_HTTPMessage):
    ...
    def resolve(self, settings, msg=None):
        ...
        if self.ws:
            ...
            headers = mock_server.mitmim.mitmproxy.net.websockets.server_handshake_headers(
...
class Request(_HTTPMessage):
    ...
    def resolve(self, settings, msg=None):
        ...
        if self.ws:
            ...
            for i in mock_server.mitmim.mitmproxy.net.websockets.client_handshake_headers().fields:
                if not get_header(i[0], self.headers):
                    tokens.append(
                        Header(
                            base.TokValueLiteral(i[0].decode()),
