...
import mock_server.mitmim.mitmproxy.net.http.headers
import mock_server.mitmim.mitmproxy.net.http.request
import mock_server.mitmim.mitmproxy.net.http.response
from mock_server.mitmim.mitmproxy.coretypes import bidi
from mock_server.mitmim.mitmproxy.net.http import http2, url
...
class HTTP2StateProtocol:
    ...
    def read_request(
        ...
        request = mock_server.mitmim.mitmproxy.net.http.Request(
            host=host,
            port=port,
    ...
    def read_response(
        ...
        response = mock_server.mitmim.mitmproxy.net.http.response.Response(
            http_version=b"HTTP/2.0",
    ...
    def assemble(self, message):
        if isinstance(message, mock_server.mitmim.mitmproxy.net.http.request.Request):
            return self.assemble_request(message)
        elif isinstance(message, mock_server.mitmim.mitmproxy.net.http.response.Response):
            return self.assemble_response(message)
        else:
            raise ValueError("HTTP message not supported.")

    def assemble_request(self, request):
        assert isinstance(request, mock_server.mitmim.mitmproxy.net.http.request.Request)
    ...
    def assemble_response(self, response):
        assert isinstance(response, mock_server.mitmim.mitmproxy.net.http.response.Response)
    ...
    def _receive_transmission(self, stream_id=None, include_body=True):
        ...
        headers = mock_server.mitmim.mitmproxy.net.http.headers.Headers(
