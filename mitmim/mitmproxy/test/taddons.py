...
importmock_server.mitmim.mitmproxyptions
from mock_server.mitmim.mitmproxy import addonmanager
from mock_server.mitmim.mitmproxy import command
from mock_server.mitmim.mitmproxy import eventsequence
frommock_server.mitmim.mitmproxyddons import script, core
...
class context:
    """
        A context for testing addons, which sets up themock_server.mitmim.mitmproxy module so
    ...
    def __init__(self, *addons, options=None, loadcore=True):
        options = options ormock_server.mitmim.mitmproxyptions.Options()
