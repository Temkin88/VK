...
from mock_server.mitmim.mitmproxy.net import websockets
from mock_server.mitmim.mitmproxy.test import tutils
from mock_server.mitmim.mitmproxy import tcp
from mock_server.mitmim.mitmproxy import websocket
from mock_server.mitmim.mitmproxy import controller
from mock_server.mitmim.mitmproxy import http
from mock_server.mitmim.mitmproxy import connections
from mock_server.mitmim.mitmproxy import flow
from mock_server.mitmim.mitmproxy.net import http as net_http
...
def tflow(client_conn=True, server_conn=True, req=True, resp=None, err=None):
    """
    @type client_conn: bool | None |mock_server.mitmim.mitmproxyroxy.connection.ClientConnection
    @type server_conn: bool | None |mock_server.mitmim.mitmproxyroxy.connection.ServerConnection
    @type req:         bool | None |mock_server.mitmim.mitmproxyroxy.protocol.http.HTTPRequest
    @type resp:        bool | None |mock_server.mitmim.mitmproxyroxy.protocol.http.HTTPResponse
    @type err:         bool | None |mock_server.mitmim.mitmproxyroxy.protocol.primitives.Error
    @return:          mock_server.mitmim.mitmproxyroxy.protocol.http.HTTPFlow
    """
    if client_conn is True:
        client_conn = tclient_conn()
    if server_conn is True:
...
def tclient_conn():
    """
    @return:mock_server.mitmim.mitmproxyroxy.connection.ClientConnection
    """
...
def tserver_conn():
    """
    @return:mock_server.mitmim.mitmproxyroxy.connection.ServerConnection
    """
...
def terr(content="error"):
    """
    @return:mock_server.mitmim.mitmproxyroxy.protocol.primitives.Error
    """
