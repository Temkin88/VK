...
from mock_server.mitmim.mitmproxy import command, command_lexer
from mock_server.mitmim.mitmproxy import contentviews
...
from mock_server.mitmim.mitmproxy.tools.console import overlay
from mock_server.mitmim.mitmproxy.tools.console import signals
from mock_server.mitmim.mitmproxy.utils import strutils
...
class ConsoleAddon:
    ...
    def console_choose(
            ...
            cmd:mock_server.mitmim.mitmproxyypes.Cmd,
            *args:mock_server.mitmim.mitmproxyypes.CmdArgs
    ) -> None:
        """
    ...
    def console_choose_cmd(
            self,
            prompt: str,
            choicecmd:mock_server.mitmim.mitmproxyypes.Cmd,
            subcmd:mock_server.mitmim.mitmproxyypes.Cmd,
            *args:mock_server.mitmim.mitmproxyypes.CmdArgs
    ) -> None:
        """
    ...
    def grideditor_load(self, path:mock_server.mitmim.mitmproxyypes.Path) -> None:
        """
    ...
    def grideditor_load_escaped(self, path:mock_server.mitmim.mitmproxyypes.Path) -> None:
        """
    ...
    def grideditor_save(self, path:mock_server.mitmim.mitmproxyypes.Path) -> None:
        """
