...
frommock_server.mitmim.mitmproxyools.console import common, searchable
frommock_server.mitmim.mitmproxytils import human
...
def flowdetails(state, flow: mock_server.mitmim.mitmproxy.flow.Flow):
    text = []
