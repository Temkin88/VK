...
importmock_server.mitmim.mitmproxyools.web.master  # noqa
...
def flow_to_json(flow:mock_server.mitmim.mitmproxylow.Flow) -> dict:
    """
...
class RequestHandler(tornado.web.RequestHandler):
    ...
    @property
    def flow(self) ->mock_server.mitmim.mitmproxylow.Flow:
