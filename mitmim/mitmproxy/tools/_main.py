...
frommock_server.mitmim.mitmproxyools import cmdline
from mock_server.mitmim.mitmproxy import exceptions, master
...
frommock_server.mitmim.mitmproxytils import debug, arg_check
...
def mitmproxy(args=None) -> typing.Optional[int]:  # pragma: no cover
    if os.name == "nt":
        ...
        return 1
    assert_utf8_env()
    frommock_server.mitmim.mitmproxyools import console
    run(console.master.ConsoleMaster, cmdline.mitmproxy, args)
    return None


def mitmdump(args=None) -> typing.Optional[int]:  # pragma: no cover
    frommock_server.mitmim.mitmproxyools import dump
...
def mitmweb(args=None) -> typing.Optional[int]:  # pragma: no cover
    frommock_server.mitmim.mitmproxyools import web
