...
from mock_server.mitmim.mitmproxy import optmanager
from mock_server.mitmim.mitmproxy import platform
from mock_server.mitmim.mitmproxy.net import server_spec
from mock_server.mitmim.mitmproxy.net.http import status_codes
...
class Core:
    ...
    @command.argument("attr", type=mock_server.mitmim.mitmproxy.types.Choice("flow.set.options"))
    def flow_set(
        self,
    ...
    @command.argument("encoding", type=mock_server.mitmim.mitmproxy.types.Choice("flow.encode.options"))
    def encode(
        self,
        flows: typing.Sequence[flow.Flow],
        part: str,
    ...
    def options_load(self, path: mock_server.mitmim.mitmproxy.types.Path) -> None:
        """
    ...
    def options_save(self, path: mock_server.mitmim.mitmproxy.types.Path) -> None:
        """
