...
from mock_server.mitmim.mitmproxy import ctx, http
from mock_server.mitmim.mitmproxy import exceptions
from mock_server.mitmim.mitmproxy import flow
from mock_server.mitmim.mitmproxy.net.http.http1 import assemble
...
class Export():
    ...
    def file(self, format: str, flow: flow.Flow, path: mock_server.mitmim.mitmproxy.types.Path) -> None:
        """
