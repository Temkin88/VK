...
from mock_server.mitmim.mitmproxy.net import server_spec, tls
from mock_server.mitmim.mitmproxy.net.http import http1
from mock_server.mitmim.mitmproxy.net.http.url import hostport
...
class ClientPlayback:
    ...
    def load_file(self, path: mock_server.mitmim.mitmproxy.types.Path) -> None:
        """
