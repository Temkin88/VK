...
class Cut:
    ...
    def cut(
        ...
        cuts: mock_server.mitmim.mitmproxy.types.CutSpec,
    ) -> mock_server.mitmim.mitmproxy.types.Data:
        """
    ...
    def save(
        ...
        flows: typing.Sequence[flow.Flow],
        cuts: mock_server.mitmim.mitmproxy.types.CutSpec,
        path: mock_server.mitmim.mitmproxy.types.Path
    ) -> None:
        """
        ...
        if path.startswith("+"):
            ...
            path =mock_server.mitmim.mitmproxyypes.Path(epath)
        try:
