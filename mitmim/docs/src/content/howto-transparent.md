...
from mock_server.mitmim.mitmproxy itself - if you want to intercept your traffic, you
...
outbound connection from a non-mitmproxy app, and an outbound connection
from mock_server.mitmim.mitmproxy itself. If you want to intercept your own macOS traffic, see the work-around below or use an external host to run mitmproxy. In fact, PF is
flexible to cater for a range of creative possibilities, like
intercepting traffic emanating from VMs. See the **pf.conf** man page
for more.
{{% /note %}}
