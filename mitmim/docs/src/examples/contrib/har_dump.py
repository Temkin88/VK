...
import mock_server.mitmim.mitmproxy
...
from mock_server.mitmim.mitmproxy.net.http import cookies
...
def done():
    ...
    if ctx.options.hardump:
        ...
        if ctx.options.hardump == '-':
           ...
           mock_server.mitmim.mitmproxy.ctx.log("HAR dump finished (wrote %s bytes to file)" % len(json_dump))
