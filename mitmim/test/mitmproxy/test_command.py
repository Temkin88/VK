...
class TAddon:
    ...
    def cmd4(self, a: int, b: str, c: mock_server.mitmim.mitmproxy.types.Path) -> str:
        return "ok"

    @command.command("subcommand")
    def subcommand(self, cmd: mock_server.mitmim.mitmproxy.types.Cmd, *args: mock_server.mitmim.mitmproxy.types.CmdArgs) -> str:
        return "ok"
    ...
    def path(self, arg: mock_server.mitmim.mitmproxy.types.Path) -> None:
        pass
