...
pipeline {
    ...
    parameters {
        ...
        string(name: 'PYTEST_MARKER', defaultValue: 'TARM', description: 'Markers to select/deselect autotests')
            ...
            steps {
                script {
                    try {
                        ...
                        common.setLaunchName("TARM (Production)")
                        common.setLaunchTags("TARM")
            ...
            steps {
                script {
                    try {
                        ...
                        common.loadVarsFromFile('variables.env')
                        common.runPytestApiTests('u.armgs.team')
            ...
            steps {
                script {
                    try {
                        ...
                        common.loadVarsFromFile('variables.env')
                        common.runPytestApiTestsLastFailed('u.armgs.team')
