...
pipeline {
    ...
    parameters {
        ...
        string(name: 'PYTEST_MARKER', defaultValue: 'VKTI', description: 'Markers to select/deselect autotests')
            ...
            steps {
                script {
                    try {
                        ...
                        common.setLaunchName("VKTI (Production)")
                        common.setLaunchTags("VKTI")
