...
@allure.title(
    "Включен асинхронный режим debug_mode: true.Отправка файла с чувстительными данными в личку/группу/канал/избранное."
)
@VKTI
@PRE_VKTI
@SAAS
...
def test_upload_file_with_sensitive_data_and_debug_mode_true(
    chat_type,
