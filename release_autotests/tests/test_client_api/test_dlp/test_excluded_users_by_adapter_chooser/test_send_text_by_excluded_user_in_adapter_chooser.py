...
@allure.title(
    "Логин пользователя добавлен в исключение в adapter_chooser. Отправка сообщений в личку/группу/канал/избранное"
)
@VKTI
@PRE_VKTI
@SAAS
...
def test_send_text_by_excluded_user_in_adapter_chooser(
    chat_type,
