...
@allure.title("Сообщение разрешено при ошибке анализа и strategy_on_fail=ok")
@VKTI
@PRE_VKTI
@SAAS
@PRE_SAAS
...
def test_send_message_analysis_fail_and_strategy_on_fail_ok(
    chat_type, prepare_test_chats_msg, send_func, check_event_send_message_event_exist, chat_entities
):
    """
    Проверяет, что если DLP не может проанализировать сообщение, но strategy_on_fail=ok,
