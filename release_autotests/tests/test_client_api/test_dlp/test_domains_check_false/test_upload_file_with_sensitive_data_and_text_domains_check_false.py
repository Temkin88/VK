...
@allure.title(
    "Домены настроены на дефолтный адатер. Если ответ от DLP по файлу запретить, система (Вахтёр) "
    "не должна давать доступ к файлу (чтение/скачивание) отправителю/получателю"
)
@VKTI
@PRE_VKTI
@SAAS
...
def test_upload_file_with_sensitive_data_and_text_domains_check_false(
    chat_type,
