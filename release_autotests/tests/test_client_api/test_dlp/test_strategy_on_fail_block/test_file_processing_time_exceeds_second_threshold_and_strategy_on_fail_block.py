...
@allure.title(
    ...
    " и в конфиге настроен strategy_on_fail: block, система (Вахтёр) должна запретить"
...
def test_file_processing_time_exceeds_second_threshold_and_strategy_on_fail_block(
    chat_type,
    ...
    with allure.step("Отправляем файл получателю"):
        status_code, msg_id = send_func(main_acc, chat, url=file_url)
