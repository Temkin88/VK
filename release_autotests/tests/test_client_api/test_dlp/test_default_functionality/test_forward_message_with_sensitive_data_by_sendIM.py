...
@allure.title("Пересылка сообщения с чувствительными данными через sendIM")
@VKTI
@PRE_VKTI
@SAAS
@PRE_SAAS
...
def test_forward_message_with_sensitive_data_by_sendIM(
    chat_type,
    chat_entities,
):
    """
    Пересылка обычного текстового сообщения с чувствительными данными
    """
