...
@allure.title("Положительные сценарии по работе с suggestions в чатах")
#@PRE_SAAS
#@PRE_TARM
#@PRE_VKTI
@SANDBOX
def test_suggest(
    ...
    go_suggest_mailing(
        ...
        suggest_params = {
            "text_smart_reply": {
                "sn": auth_account.uin,
                "msg_id": message_id_first,
                "suggests_array": ["Hello", "How are you?", "Goodbye"],
                "send_to": auth_account.uin,
            }
        })
