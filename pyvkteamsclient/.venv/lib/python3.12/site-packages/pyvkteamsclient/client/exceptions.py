...
from pyvkteamsclient.service_type import path_to_service_relation
...
class BaseRequestException(Exception):
    ...
    def get_error_message(self) -> str:
        ...
        *_, real_path = re.split(r"/api/v[\d+]+", self.path_url)
        ...
        services = ", ".join(path_to_service_relation.get(real_path, ["UNKNOWN SERVICES"]))
...
Failed request:
{http_request_plain_text}""".format(services=services, core_error_messge=core_error_messge, **self.__dict__)
