...
class MessagesMethods(BaseClient):
    ...
    @tracer.start_as_current_span("messages.rapi_getHistory")
    def rapi_getHistory(
        self,
        sn: str,
    ...
    @api_version_check(min_version=1)
    @tracer.start_as_current_span("messages.rapi_delMsgBatch")
    ...
    @api_version_check(min_version=1)
    @tracer.start_as_current_span("messages.rapi_setDlgState")
    ...
    @api_version_check(min_version=52)
    @tracer.start_as_current_span("messages.rapi_draft_set")
    def rapi_draft_set(self, sn: str, parts: list[dict], mentions: Optional[list[str]] = None) -> dict:
        """
    ...
    @api_version_check(min_version=84)
    @tracer.start_as_current_span("messages.rapi_pinMessage")
    def rapi_pinMessage(self, sn: str, msgId: Union[str, int], unpin: bool = False) -> dict:
        """
    ...
    @api_version_check(min_version=129)
    @tracer.start_as_current_span("message.rapi_message_send")
    def rapi_message_send(
        ...
        **kwargs: Unpack[RapiMsgSendPartsKwargs],
        ...
        return self.post(
            path="rapi/message/send",
            json={
                "aimsid": aimsid if aimsid else self.aimsid,
                "reqId": self.getReqId(),
                "params": {"target": target, **kwargs},
            },
        )

    @tracer.start_as_current_span("messages.rapi_message_scheduled_cancel")
    @api_version_check(min_version=118)
    def rapi_message_scheduled_cancel(self, sn: str, scheduled_msg_ids: Optional[list[str | int]] = None):
        """
        ...
        return self.post(
            path="rapi/message/scheduled/cancel",
            headers={"Content-Type": "application/json"},
            json={
                "aimsid": self.aimsid,
                "reqId": self.getReqId(),
    ...
    @tracer.start_as_current_span("messages.rapi_message_scheduled_flush")
    @api_version_check(min_version=118)
    def rapi_message_scheduled_flush(self, sn: str, scheduled_msg_ids: list[str | int]):
        """
        ...
        """
        return self.post(
            path="rapi/message/scheduled/flush",
            headers={"Content-Type": "application/json"},
            json={
                "aimsid": self.aimsid,
                "reqId": self.getReqId(),
    ...
    @tracer.start_as_current_span("messages.rapi_message_scheduled_history_get")
    @api_version_check(min_version=118)
    def rapi_message_scheduled_history_get(self, sn: str, history_version: str = "0"):
        """
        Отправить запланированные,
        которые в текущий момент находятся
        в очереди запланированных мгновенно сейчас.
        ...
        """
        return self.post(
            path="rapi/message/scheduled/history/get",
            headers={"Content-Type": "application/json"},
            json={
                "aimsid": self.aimsid,
                "reqId": self.getReqId(),
    ...
    @tracer.start_as_current_span("messages.rapi_receivedMessages")
    def rapi_receivedMessages(self, sn: str, msg_ids: list[int | str]):
        return self.post(
            path="rapi/receivedMessages",
            headers={"Content-Type": "application/json"},
            json={
                "aimsid": self.aimsid,
                "reqId": self.getReqId(),
